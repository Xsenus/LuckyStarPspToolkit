...
untrusted assembly. The same ReserveComparisonFixture.cs is compiled for both revisions.
.PARAMETER Root
...
$entry = 'global using System; global using System.IO; global using System.Linq; global using System.Collections.Generic; global using System.Security.Cryptography; global using LuckyStarPspToolkit.Licensing; global using LuckyStarPspToolkit.Licensing.Authority; return ReserveComparisonFixture.Run(args);'
$trees.Add([Microsoft.CodeAnalysis.CSharp.CSharpSyntaxTree]::ParseText($entry, $parse))
$fixture = Join-Path $Root 'tests/LuckyStarPspToolkit.Licensing.SelfTests/ReserveComparisonFixture.cs'
...
$compilation = [Microsoft.CodeAnalysis.CSharp.CSharpCompilation]::Create('ReserveComparisonProbe', $trees, $refs, $options)
$outputAssembly = Join-Path $Out 'ReserveComparisonProbe.dll'
