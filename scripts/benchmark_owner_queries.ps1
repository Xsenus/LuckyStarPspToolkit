...
untrusted assembly. The same OwnerQueryComparisonFixture.cs is compiled for both revisions.
.PARAMETER Root
...
.PARAMETER Probe
Reserved compatibility switch; both historical probes and performance samples are reported.
#>
param(
...
$entry = 'global using System; global using System.IO; global using System.Linq; global using System.Collections.Generic; global using System.Security.Cryptography; global using LuckyStarPspToolkit.Licensing; global using LuckyStarPspToolkit.Licensing.Authority; return OwnerQueryComparisonFixture.Run(args);'
$trees.Add([Microsoft.CodeAnalysis.CSharp.CSharpSyntaxTree]::ParseText($entry, $parse))
$fixture = Join-Path $Root 'tests/LuckyStarPspToolkit.Licensing.SelfTests/OwnerQueryComparisonFixture.cs'
...
$compilation = [Microsoft.CodeAnalysis.CSharp.CSharpCompilation]::Create('OwnerQueryComparisonProbe', $trees, $refs, $options)
$outputAssembly = Join-Path $Out 'OwnerQueryComparisonProbe.dll'
