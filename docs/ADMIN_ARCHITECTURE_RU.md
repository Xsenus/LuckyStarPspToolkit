...
Request body ограничен 32 КиБ; обработка ограничена 8 одновременно и 15 секундами.
...
Массив лицензий имеет серверные ограничения базы; браузер фильтрует и показывает по 25.
Полноценная серверная пагинация и многопользовательский RBAC — будущие задачи, не заявленные функции.
